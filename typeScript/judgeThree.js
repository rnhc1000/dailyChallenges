...
var findJudge = function (n, trust) {
    ...
    for (let m = 0; m < possibleJudges.length; m++) {
        ...
        newJudges.set(possibleJudges[m], count);
        count=0;

    }
    console.log("Array Of Judges...", arrayOfJudges);
    console.log(objectOfTrust);
    console.log("Array Of Trust...", arrayOfTrust);
    console.log("New.... ", newJudges);
...
//newJudges.set(i, true);
//}

//console.log("Map.... ", newJudges);
