...
array_key_exists('hostname', $array) ? $status = true : $status =false;


if (!$statux) {
    $array['hostname'] = 'Ipv6 Customers do not return hostname';
};
var_dump($array);
echo "<br>" . $statux;
$status=2;
$mensagem ="APROVADA " . " m  "  . "773456789 ";

echo "<br>" . $mensagem;

$status = preg_match('/(\bAPROVAD[OA][ ]{1,}[0-9]*\b)/', $mensagem) ? 1 : 0;
